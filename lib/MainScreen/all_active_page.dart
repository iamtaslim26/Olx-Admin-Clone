...
class AllActivePage extends StatefulWidget {


  @override
  _AllActivePageState createState() => _AllActivePageState();
}

class _AllActivePageState extends State<AllActivePage> {
  ...
  void initState() {
    ...
    FirebaseFirestore.instance.collection("Olx Users").where("status",isEqualTo: "approved")
    .get().then((value) {
              ...
              actions: [
                ...
                onPressed: (){
                  ...
                  .then((value) {
                    ...
                    Fluttertoast.showToast(msg: "Account Blocked Successfully. . .",timeInSecForIosWeb: 2);
